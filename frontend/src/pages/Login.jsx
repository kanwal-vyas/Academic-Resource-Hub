...
function Login({ isDark, onToggleTheme }) {
  ...
  // ❌ REMOVED: local theme state, useEffect, toggleTheme — they were
  //    toggling documentElement (html) not body, and duplicating state
      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p className="auth-subtitle">Sign in to access shared academic resources</p>
          </div>
